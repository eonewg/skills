...
3. Use `read` tool on: `/home/<user>/agent-workspace/images/logo.png` (absolute path)
...
# Output: File found at /home/<user>/agent-workspace/photos/vacation.jpg

# Local file example (absolute)
python3 scripts/smart_image_loader.py /home/<user>/agent-workspace/downloads/graphic.png
# Output: File found at /home/<user>/agent-workspace/downloads/graphic.png
```
