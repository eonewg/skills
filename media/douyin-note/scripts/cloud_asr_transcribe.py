#!/usr/bin/env python3
"""Cloud ASR adapter for douyin-note archives.
...
def volcengine_payload(args: argparse.Namespace, defaults: dict[str, Any], audio_url: str) -> dict[str, Any]:
    ...
    payload = {
        "user": {"uid": args.uid or "douyin-note"},
        "audio": audio,
        "request": request,
    }
    if args.callback:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--uid", default="douyin-note", help="Volcengine user.uid. Default: douyin-note")
